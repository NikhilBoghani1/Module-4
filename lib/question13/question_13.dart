...
import 'package:module_4_main_project/model/allData.dart';
...
class _Question13State extends State<Question13> {
  ...
  List<CardItemImage> cardImageList = [
    CardItemImage(image: 'image/noodle.jpg'),
    CardItemImage(image: 'image/pizza.jpg'),
    CardItemImage(image: 'image/pasta.jpg'),
    CardItemImage(image: 'image/burger.jpg'),
    CardItemImage(image: 'image/noodle.jpg'),
    CardItemImage(image: 'image/pizza.jpg'),
  ];
